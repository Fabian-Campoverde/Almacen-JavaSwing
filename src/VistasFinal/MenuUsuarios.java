...
public class MenuUsuarios extends javax.swing.JFrame {
    ...
    public MenuUsuarios() {
        ...
        txt.addOption(new SearchOption("Nombres", new FlatSVGIcon("Img/user-search.svg")));
    ...
    public void listar() {
        ...
        for (int i = 0; i < lista.size(); i++) {
            ...
            ob[2] = lista.get(i).getNombres() + " " + lista.get(i).getApellidos();
    ...
    private void initComponents() {
        ...
        tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "", "DNI", "Nombres", "Telefono", "Tipo", "Correo", "Contraseña"
            }
        ) {
...
//        this.setVisible(false);
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        ...
        if (confirmacion == 0) {
            ControladorUsuario.deleteDatos(datosEliminados);
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
        ...
        List<bUsuario> lista2 = ControladorUsuario.listar(1);

        if (fila == -1) {
            JOptionPane.showMessageDialog(null, "Selecciona usuario a modificar");
        } else {
            for (int i = 0; i < lista2.size(); i++) {

                if (tabla.getValueAt(fila, 2).toString().equals(lista2.get(i).getNombres() + " " + lista2.get(i).getApellidos())) {
                    name = lista2.get(i).getNombres();
                    last = lista2.get(i).getApellidos();
                }
            ...
            UpdateUsuario.Datos(lista);
            UpdateUsuario u = new UpdateUsuario();
            u.Update(this);
            u.setVisible(true);
        }
