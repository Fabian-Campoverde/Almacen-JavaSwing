 ...
 */
public class UpdateProveedor extends javax.swing.JFrame {
    ...
    public UpdateProveedor() {
        initComponents();
        if (!lista.isEmpty()) {
            ruc.setText(lista.get(0));
            razon.setText(lista.get(1));
            nombre.setText(lista.get(2));
            telefono.setText(lista.get(3));
            direccion.setText(lista.get(4));
        }
...
//                user.setLocation(275,45);
    ...
    public void Update(MenuProveedor menuCategoria) {
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
        ...
        if (raz.equals("") || nom.equals("") || dir.equals("") || RUC.equals("") || telefono.getText().equals("")) {
            ...
            String msg = ControladorProveedor.decisor(2);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UpdateProveedor().setVisible(true);
