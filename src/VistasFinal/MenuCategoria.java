...
public class MenuCategoria extends javax.swing.JFrame {
    ...
    public MenuCategoria() {
        ...
        txt.addOption(new SearchOption("Id", new FlatSVGIcon("Img/category.svg")));
        txt.addOption(new SearchOption("Nombre", new FlatSVGIcon("Img/file-text.svg")));
        txt.addOption(new SearchOption("Descripcion", new FlatSVGIcon("Img/align-box-center-middle.svg")));
    ...
    public void listar() {
        List<bCategoria> lista = ControladorCategoria.listar(1);
    ...
    private void applyStyleTable(JTable table) {
        add.setIcon(new FlatSVGIcon("Img/apps-filled.svg"));
    ...
    private void addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addActionPerformed
        RegistroCategoria r = new RegistroCategoria();
        r.Registro(this);
        r.setVisible(true);
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        ...
        int confirmacion = JOptionPane.showConfirmDialog(rootPane, "¿Estas seguro de eliminar la categoria?", "Confirmar", 2);
        if (confirmacion == 0) {
            ControladorCategoria.deleteDatosCatego(datosEliminados);
            String msg = ControladorCategoria.decisor(3);
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
        ...
        List<bCategoria> lista2 = ControladorCategoria.listar(1);

        if (fila == -1) {
            JOptionPane.showMessageDialog(null, "Selecciona categoria a modificar");
        } else {
            ...
            UpdateCategoria.Datos(lista);
            UpdateCategoria u = new UpdateCategoria();
            u.Update(this);
            u.setVisible(true);
        }
