...
//                user.setLocation(275,45);
    ...
    public void Registro(MenuProducto menuCategoria) {
    ...
    private void insertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_insertActionPerformed
        ...
        Timestamp tiempo = new Timestamp(fechaHoraActual.getTime());
        ...
        if (codigo.getText().equals("") || name.equals("") || med.equals("") || cantidad==0 || catego.equals("") || cantidad_min==0) {
            ...
            ControladorProducto.setDatosProducto(cod, name, med, cantidad, catego, tiempo, cantidad_min);
            String msg=ControladorProducto.decisor(1);
