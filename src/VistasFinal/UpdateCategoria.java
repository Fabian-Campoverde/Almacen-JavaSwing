 ...
 */
public class UpdateCategoria extends javax.swing.JFrame {
    ...
    public UpdateCategoria() {
        initComponents();
        if (!lista.isEmpty()) {
            id.setText(lista.get(0));
            name.setText(lista.get(1));
            desc.setText(lista.get(2));
        }
        id.setEnabled(false);
    }
...
private MenuCategoria menu;
    ...
    public void Update(MenuCategoria menuCategoria) {
...
//                user.setLocation(275,45);
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
        ...
        int cod;
        cod = Integer.parseInt(id.getText());
        nom = name.getText();
        descripcion = desc.getText();
        if (nom.equals("") || descripcion.equals("")) {
            JOptionPane.showMessageDialog(null, "Ingresar datos correctos");
        } else {
            ControladorCategoria.setDatosCatego(cod, nom, descripcion);
            String msg = ControladorCategoria.decisor(2);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateCategoria.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UpdateCategoria().setVisible(true);
