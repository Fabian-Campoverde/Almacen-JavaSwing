...
public class MenuProveedor extends javax.swing.JFrame {
    ...
    public MenuProveedor() {
        ...
        txt.addOption(new SearchOption("RUC", new FlatSVGIcon("Img/category.svg")));
        txt.addOption(new SearchOption("Razon Social", new FlatSVGIcon("Img/file-text.svg")));
        txt.addOption(new SearchOption("Nombre", new FlatSVGIcon("Img/align-box-center-middle.svg")));
    ...
    public void listar() {
        List<bProveedor> lista = ControladorProveedor.listar(1);
    ...
    private void initComponents() {
        ...
        tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "", "RUC", "Razon Social", "Nombre Comercial", "Telefono", "Direccion"
            }
        ) {
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        ...
        if (confirmacion == 0) {
            ControladorProveedor.deleteDatosCatego(datosEliminados);
            String msg = ControladorProveedor.decisor(3);
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
        ...
        List<bProveedor> lista2 = ControladorProveedor.listar(1);
        ...
        if (fila == -1) {
            ...
            UpdateProveedor.Datos(lista);
            UpdateProveedor u = new UpdateProveedor();
            u.Update(this);
            u.setVisible(true);
        }
...
//        pro.setVisible(false);
    ...
    private void jLabel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MouseClicked
        MenuCategoria c= new MenuCategoria();
